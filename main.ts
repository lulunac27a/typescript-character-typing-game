const game = () => {
    ...
    const timeText = document.getElementById(
        "time-remaining",
    ) as HTMLSpanElement; //time remaining text
    const typingText = document.getElementById(
        "typing-text",
    ) as HTMLInputElement; //typing text field
    const startButton = document.getElementById(
        "start-button",
    ) as HTMLButtonElement; //start button
    const gameMode = document.getElementById("mode") as HTMLSelectElement; //game mode
    const timeLimit = document.getElementById(
        "time-limit",
    ) as HTMLSelectElement; //time limit selection
